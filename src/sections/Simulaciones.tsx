    ...
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configuración, resultados y análisis de simulaciones SPICE.
        </p>
      </div>
      ...
      <ToggleBlock title="Análisis DC - Punto de Operación (.OP)" defaultOpen>
        ...
        <MultiImageGallery
          sectionId="sim-dc"
          columns={2}
          placeholder="Añadir gráfica DC"
          defaultLabel="Gráficas DC"
          showDate
        />
      </ToggleBlock>
      ...
      <ToggleBlock title="Análisis AC - Respuesta en Frecuencia (.AC)">
        ...
        <h4 className="text-sm font-semibold text-foreground mb-2 mt-4">
          📈 Gráficas de Respuesta en Frecuencia (AC)
        </h4>
        <MultiImageGallery
          sectionId="sim-ac"
          columns={1}
          placeholder="Añadir gráfica AC"
          defaultLabel="Gráficas AC"
          showDate
        />
      </ToggleBlock>
      ...
      <ToggleBlock title="Análisis Transitorio (.TRAN)">
        ...
        <MultiImageGallery
          sectionId="sim-tran"
          columns={2}
          placeholder="Añadir gráfica transitoria"
          defaultLabel="Gráficas Transitorias"
          showDate
        />
      </ToggleBlock>

      {/* ⚠️ Sección "Simulación de aplicaciones" eliminada según requisitos */}
    </div>
  );
}
