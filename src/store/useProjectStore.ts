  ...
  tables: {
    ...
    'versiones': {
      ...
      rows: [
        ...
        { id: 'v5', cells: ['v2.2', '2026-02-13', 'Implementación de ultima etapa', 'Equipo', 'Inicial'] },
        { id: 'v6', cells: ['v2.3', '2026-02-13', 'Ajuste de niveles de polarización de la los BJT', 'Equipo', 'Modificación'] },
