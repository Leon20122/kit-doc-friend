...
const defaultData: ProjectData = {
  ...
  tables: {
    ...
    'versiones': {
      ...
      rows: [
        ...
        { id: 'v7', cells: ['v2.4', '2026-02-13', 'Implementación del Feedback (en simulación) e implementación de Par dif con carga activa', 'Equipo', 'Inicial'] },
    ...
    'conclusiones-objetivos': {
      ...
      rows: [
        ...
        { id: 'co4', cells: ['Construir prototipo en protoboard', '✅ Completado'] },
        { id: 'co6', cells: ['Documentar con trazabilidad', '✅ Completado'] },
        { id: 'conclusiones-objetivos-1772833166145', cells: ['Presentación del OpAmp en funcionamiento en PCB', '✅ Completado'] },
      ],
    },
  ...
  notes: {
    ...
    'gallery-blocks-mediciones-osciloscopio': '[{"id":"mediciones-osciloscopio-default","label":"Fotos Osciloscopio","date":"2026-02-11"},{"id":"mediciones-osciloscopio-1772832287054","label":"Fotos Osciloscopio","date":"2026-03-13"},{"id":"mediciones-osciloscopio-1772832312600","label":"Fotos Osciloscopio","date":"2026-03-20"}]',
    'gallery-blocks-diseno-etapas': '[{"id":"diseno-etapas-default","label":"Esquemático de Fuente de corriente y Espejo de corriente","date":"2026-02-06"},{"id":"diseno-etapas-1772828904781","label":"Esquemático de Espejo de corriente + Par diferencial (carga pasiva)","date":"2026-03-11"},{"id":"diseno-etapas-1772828905919","label":"Esquemático de Espejo + Par dif+ Etapa 2 (pseudo final) - Prueba de swing","date":"2026-03-13"},{"id":"diseno-etapas-1772828907460","label":"Esquemático de Espejo + Par dif (carga activa)","date":"2026-03-13"},{"id":"diseno-etapas-1772831712017","label":"Esquemático de Espejo + Par dif (carga activa) + Etapa emisor común con carga activa","date":"2026-03-13"}]',
    ...
    'problems-list': '[{"id":"p1","title":"Problema #001: Discrepancias muy grandes entre simulación y realidad ","date":"2026-02-06","symptom":"Al momento de medir los puntos de operación DC, los datos obtenidos con los equipos de medición (fluke 179), diferian mucho de los vistos en la simulación de las primeras etapas. Se pensaba que podria deberse a el comportamiento no lineal de la fabricación de los BJt\\u0027s ","diagnosis":"","rootCause":"Hacia falta una conexión que no se había realizado a la hora de montar el transistor que funciona como fuente de corriente","solution":"Se tuvo que cortocircuitar con un cable en la protoboard para poder arreglar este comportamiento extraño. Como resultado, loas mediciones con los equipos del lab ahora coincidían en gran medida con la simulación ","lesson":""},{"id":"p2","title":"Problema #002: Ganancia negativa y comportamiento raro de la fase","date":"2026-02-13","symptom":"Al implemntar el Feedback, se ve que al realizar el análisis .ac en el simulador, el resultado obtenido es muy distinto al esperado: tiene ganancia negativa (atenua) y muestra un comportamiento extraño ","diagnosis":"Mala conexión del Feecback","rootCause":"Los nodos donde se conectaban las resistencias no estaban correctamente conectados y generaba ese efecto ","solution":"Se vio con cuidado los nodos a conectar y para mayor seguridad se creo un nuevo archivo .asc para probar el Feedback dando como resultado una leve ganancia (uso de resistencias comerciales para el feedback) y un comportamiento más coherente con la fase","lesson":"Verificar tanto en simulación como en físico la conexión de los nodos/pines"},{"id":"p-1772833978889","title":"Problema #003: Rizado en salida del opamp aun con Feedback ","date":"2026-02-20","symptom":"Al conectar el generador de señales a la entrada no inversora, con el feecback en funcionamiento, se ve un rizado pronunciado en la salida del opamp","diagnosis":"Debe de faltarle añadir el capacitor de compensación miller para corregir el MP (margen de fase)","rootCause":"Efectivamente, al realizar la simulación, el margen de fase con feedback es de 62º y debe estar entre 45 y 60º para que sea estable","solution":"Variar los valores del capacitor miller hasta obtener un MP entre 45 y 60º (58º en este caso))","lesson":"Verificar antes en la simulación si se presenta dicho efecto para que solo sea llegar a probar en fisico lo probado en la simulación"}]',
